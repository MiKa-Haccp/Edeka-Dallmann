    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#f94d00] text-white text-sm font-bold disabled:opacity-50 hover:bg-[#f94d00] transition-colors"
        >
        ...
        {!done ? (
          <div className="w-full bg-white rounded-2xl border border-border shadow-sm p-5 space-y-4">
            ...
            <input
              ...
              placeholder="PIN"
              className="w-full text-center text-2xl tracking-[0.5em] border border-border rounded-xl px-4 py-3 font-bold focus:outline-none focus:ring-2 focus:ring-[#f94d00]/30"
            ...
            <button
              onClick={handleVerify}
              disabled={loading || pin.length < 4}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#f94d00] text-white text-sm font-bold disabled:opacity-50 hover:bg-[#f94d00] transition-colors"
            >
              {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Check className="w-4 h-4" />}
              Abzeichnen
            </button>
            ...
            >
              <table className="w-full text-sm border-collapse">
                <thead className="sticky top-0 z-20">
                  <tr className="bg-gradient-to-br from-[#c73d00] to-[#f94d00] text-white">
                    <th className="px-3 py-3 text-left font-semibold text-xs w-16 sticky left-0 top-0 bg-[#f94d00] z-30">Tag</th>
