...
// Alle verfügbaren Kriterien für die Metzgerei (Fleisch + Fisch)
const ALL_CRIT: CritDef[] = [
  ...
  { key:"qs_by",            short:"QS-BY",         label:"Geprüft. Qualität BY geprüft i.O.",                 type:"check", group:"Fleisch" },
  // ── Fisch - Allgemein ─────────────────────────────────────
  { key:"fisch_arten_json", short:"Fisch/MHD",     label:"Fischart(en) mit Verbrauchsdatum / MHD",            type:"fisch_mhd_list", note:"Für jede gelieferte Fischart eine Zeile eintragen", group:"Fisch - Allgemein" },
  ...
  { key:"fisch_augen",      short:"Augen",         label:"Augen i.O. (klar, gewölbt, glänzend)",              type:"check", group:"Fisch - Allgemein" },
  ...
  { key:"nemat_json",       short:"Nemat.",        label:"Nematodenkontrolle durchgeführt",                   type:"nemat_list", note:"Für jeden kontrollierten Fisch eine Zeile hinzufügen", group:"Fisch - Allgemein" },
  // ── MSC-Fisch ─────────────────────────────────────────────
  { key:"fisch_msc_zertifikat", short:"MSC-Zert.", label:"MSC-Zertifikat Lieferant geprüft",                  type:"check", group:"MSC-Fisch" },
...
const CONFIG: WEBaseConfig = {
  section: "metzgerei",
  pageTitle: "3.1 Wareneingänge Metzgerei",
