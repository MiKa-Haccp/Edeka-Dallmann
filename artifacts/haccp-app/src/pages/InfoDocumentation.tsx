...
const retentionData = [
  {
    ...
    items: [
      { name: "Verantwortlichkeiten im Markt", retention: "2 Jahre", note: "Ab Ende des Kalenderjahres" },
      { name: "Unterschriften und Kürzel der Mitarbeiter", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Schulungsprotokoll", retention: "7 Jahre", note: "Nach Ausscheiden des Mitarbeiters" },
      { name: "Betriebsbegehung (Eigenkontroll-Prüfliste)", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Prüfmittelüberwachung", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Erstbelehrung nach IfSG / Gesundheitszeugnisse", retention: "7 Jahre", note: "Solange Mitarbeiter im Betrieb" },
      { name: "Ersthelferbescheinigung", retention: "7 Jahre", note: "Solange gültig / nach Ausscheiden" },
      { name: "Berichte behördlicher Kontrollen", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Berichte externer Kontrollen (TÜV, QAL, QS usw.)", retention: "3 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Berichte interner Kontrollen (QM, Bezirksleiter)", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
    ],
  },
  {
    category: "Reinigung & Hygiene",
    items: [
      { name: "Produktliste Personal- und Lebensmittelhygiene", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Reinigungsplan Woche", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Reinigungsplan Jahr", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Reinigungsdokumentation", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Hygienebelehrung abteilungsfremde Personen", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
    ],
  },
  {
    category: "Wareneingänge & Lagerung",
    items: [
      { name: "Wareneingangskontrolle", retention: "2 Jahre", note: "Ab Ende des Kalenderjahres" },
      { name: "Wareneingangskontrolle MSC-Fisch", retention: "3 Jahre", note: "Ab Erstellungsdatum" },
      { name: "MSC-Lieferscheine", retention: "3 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Lager- und Temperaturkontrolle manuell", retention: "3 Jahre", note: "Ab Ende des Kalenderjahres" },
      { name: "Lager- und Temperaturkontrolle automatisch", retention: "3 Jahre", note: "Ab Ende des Kalenderjahres" },
    ],
  },
  {
    category: "Metzgerei & Frischetheke",
    items: [
      { name: "Betriebsbegehung GQ-Frischeartikel", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Produktfehlermeldung", retention: "3 Jahre", note: "Ab Abschluss des Vorgangs" },
      { name: "Rezeptvordruck", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Bestandsliste eingefrorenes Fleisch", retention: "2 Jahre", note: "Ab Ende des Kalenderjahres" },
      { name: "Eigenherstellung / Öffnen von Gastro-Packungen", retention: "1 Jahr", note: "Ab Ende des Kalenderjahres" },
      { name: "Archivierung von Rindfleischetiketten", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Entsorgungsscheine K3-Abfälle", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
    ],
  },
  {
    category: "Bescheinigungen & sonstige Belege",
    items: [
      { name: "Durchschrift amtlicher Probenentnahme", retention: "3 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Warenrücknahmeprotokolle (REVOCO)", retention: "2 Jahre", note: "Ab Abschluss des Vorgangs" },
      { name: "Lieferschein an die Deutschen Tafeln", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
      { name: "Sonstige Berichte und Belege (z. B. Schädlingsmonitoring)", retention: "2 Jahre", note: "Ab Erstellungsdatum" },
    ],
  },
];
