      ...
      <div className="max-w-3xl mx-auto space-y-4 pb-10">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">1.12 Gesundheitszeugnisse</h1>
              <p className="text-xs text-muted-foreground">Nach §43 IfSG — Nachweise der Beschäftigten</p>
            </div>
          </div>
          {!showForm && (
            <button
